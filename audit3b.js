  ...
  function resultsHTML() {
    ...
    if (pts<=10) { desc='Critical gaps identified'; tier='LEAN & READY'; tierDesc='Minimal digital/legal silos. A standard plan is likely sufficient.'; }
    else if (pts<=22) { desc='Significant gaps remain'; tier='LEGACY AT RISK'; tierDesc='Documented but inaccessible. Single points of failure exist.'; }
    else if (pts<=30) { desc='Partially documented'; tier='CRITICAL COMPLEXITY'; tierDesc='High-value, multi-layered. Risk of permanent asset loss.'; }
    else if (pts<=36) { desc='Well organized'; tier='WELL STRUCTURED'; tierDesc='Strong foundation with minor gaps to address.'; }
    else { desc='Strongly organized'; tier='COMPREHENSIVE'; tierDesc='Thorough documentation across all pillars.'; }
