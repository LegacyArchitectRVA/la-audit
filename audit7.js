      ...
      '<div style="padding:36px 0;border-top:1px solid #2a2218;text-align:center;">'+
        ...
        '<div style="text-align:center;">'+
          ...
          '<div style="display:flex;justify-content:center;gap:32px;margin-top:28px;">'+
            '<button onclick="__la.go(7)" styl      "Without designated legacy contacts, social media accounts may be memorialized, deleted, or hijacked, with no way to recover meaningful content.",
