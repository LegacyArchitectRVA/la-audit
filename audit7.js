...
(function(){
  ...
  window.__la={
    ...
    sub:function(){
      ...
      xhr.onload=function(){if(xhr.status>=200&&xhr.status<300){var sec=document.getElementById('la-email-sec');if(sec)sec.innerHTML='<div style="font-family:Bodoni Moda,serif;font-size:16px;font-style:italic;color:#b8984e;margin-bottom:32px;">Your results have been sent. Here is your full breakdown.</div>'+detailHTML();}else{if(msg)msg.textContent='Something went wrong. Please try again.';}};
