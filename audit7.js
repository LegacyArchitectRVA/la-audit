/* LA Audit - full replacement
   Fixes:
   1) N/A button on pages 2-7
   2) Post-submit wording says "Your results are below."
   3) YES / NO business buttons use the same selected glow effect
*/
(function () {
  var lnk = document.createElement("link");
  lnk.rel = "stylesheet";
  lnk.href =
    "https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=Bodoni+Moda:ital,opsz,wght@0,6..96,400;0,6..96,500;1,6..96,300;1,6..96,400&display=swap";
  ...
  function counterHTML(pi) {
    ...
    return (
      '<div id="la-ctr-' +
      pi +
      '" style="display:flex;align-items:center;justify-content:center;margin-bottom:32px;">' +
      '<div style="display:inline-flex;align-items:baseline;gap:8px;padding:14px 32px;border:1px solid ' +
      s.border +
      ...
      '<span style="font-family:Cinzel,serif;font-size:28px;font-weight:700;color:' +
      s.numColor +
      ...
      cnt +
      "</span>" +
      '<span style="font-family:Bodoni Moda,serif;font-size:16px;font-style:italic;color:#8a7240;line-height:1;">of ' +
      totalActive +
      "</span>" +
      "</div>" +
      "</div>"
  ...
  function rowHTML(pi, ii) {
    ...
    return (
      ...
      '" class="la-item-wrap ' +
      (na ? "is-na" : "") +
      '" style="display:flex;align-items:center;justify-content:space-between;gap:12px;transition:opacity 0.3s;">' +
      '<div style="flex:1;">' +
      ...
      "-" +
      ii +
      `" class="larow" onclick="window.__la.pick(` +
      pi +
      "," +
      ii +
      `,'check')" style="display:flex;align-items:center;gap:18px;padding:16px 8px;border:1px solid ` +
      (on ? "rgba(193,176,133,0.12)" : "transparent") +
      ";border-radius:2px;cursor:pointer;transition:all 0.3s;flex-grow:1;background:" +
      (on ? "rgba(193,176,133,0.03)" : "transparent") +
      ";opacity:" +
      (na ? "0.4" : "1") +
      ";filter:" +
      (na ? "grayscale(100%)" : "none") +
      ';">' +
      '<div class="lash" style="width:24px;height:24px;flex-shrink:0;border:1px solid ' +
      (on ? "#c1b085" : "#7A6842") +
      ";border-radius:2px;background:transparent;display:flex;align-items:center;justify-content:center;transition:all 0.3s;box-shadow:" +
      (on
        ? "0 0 12px rgba(193,176,133,0.6), 0 0 24px rgba(193,176,133,0.25), inset 0 0 8px rgba(193,176,133,0.1)"
        : "none") +
      ';">' +
      '<svg class="lamk" width="14" height="11" viewBox="0 0 14 11" fill="none" style="opacity:' +
      (on ? "1" : "0") +
      ";transform:" +
      (on ? "scale(1)" : "scale(0.6)") +
      ";transition:opacity 0.2s, transform 0.2s;filter:drop-shadow(0 0 3px rgba(193,176,133,0.9));\"><path d=\"M1.5 5.5L5.5 9.5L12.5 1.5\" stroke=\"#c1b085\" stroke-width=\"1.6\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/></svg>" +
      "</div>" +
      '<span class="lalb" style="font-family:Cinzel,serif;font-size:16px;letter-spacing:2px;color:' +
      (on ? "#c1b085" : "#9a8d7a") +
      ";transition:all 0.3s;" +
      (on ? "text-shadow:0 0 12px rgba(193,176,133,0.3);" : "") +
      '">' +
      P[pi].i[ii] +
      "</span>" +
      "</label>" +
      ...
      "-" +
      ii +
      `" class="lana-btn" onclick="window.__la.pick(` +
      pi +
      "," +
      ii +
      `,'na')" style="font-family:Cinzel,serif;font-size:12px;font-weight:600;color:` +
      (na ? "#c1b085" : "#7A6842") +
      ";border:1px solid " +
      (na ? "#7A6842" : "#342a1c") +
      ";padding:6px 12px;border-radius:2px;cursor:pointer;transition:all 0.3s;background:" +
      (na ? "#342a1c" : "transparent") +
      ';">N/A</label>' +
      "</div>" +
      "</div>"
    );
  ...
  function businessGateHTML() {
    ...
    var noOn = OB === false;
    var glow =
      "0 0 12px rgba(193,176,133,0.45), 0 0 24px rgba(193,176,133,0.18)";
    return (
      ...
      '<button class="lab" onclick="window.__la.ob(true)" style="background:' +
      (yesOn ? "#c1b085" : "transparent") +
      ";color:" +
      (yesOn ? "#100d0a" : "#c1b085") +
      ";border:1px solid " +
      (yesOn ? "#c1b085" : "#7A6842") +
      ";padding:12px 26px;font-family:Cinzel,serif;font-size:13px;letter-spacing:2px;cursor:pointer;box-shadow:" +
      (yesOn ? glow : "none") +
      ';">YES</button>' +
      '<button class="lab" onclick="window.__la.ob(false)" style="background:' +
      (noOn ? "#c1b085" : "transparent") +
      ";color:" +
      (noOn ? "#100d0a" : "#c1b085") +
      ";border:1px solid " +
      (noOn ? "#c1b085" : "#7A6842") +
  ...
  function pillarHTML(pi) {
    ...
    return (
      ...
      (pi + 1) +
      ' OF 7</div>' +
      '<div style="font-family:\'Cinzel\',serif;font-size:24px;font-weight:700;color:#fdfcfa;text-align:center;letter-spacing:3px;margin-bottom:10px;">' +
      pl.n.toUpperCase() +
      "</div>" +
      ...
      (backBtn
        ? '<button class="lab" onclick="window.__la.bk(' +
          backTarget +
          ')" style="background:none;border:none;color:#b8984e;font-family:Cinzel,serif;font-size:14px;letter-spacing:3px;cursor:pointer;">' +
          backBtn +
          "</button>"
        : "<span></span>") +
      '<button class="lab" onclick="window.__la.go(' +
      (pi + 2) +
      ')" style="background:#c1b085;border:none;color:#100d0a;padding:15px 36px;font-family:Cinzel,serif;font-size:15px;font-weight:700;letter-spacing:3px;cursor:pointer;">' +
      nextBtn +
      "</button>" +
      "</div>"
    );
  ...
  function detailHTML() {
    ...
    for (var pi = 0; pi < 7; pi++) {
      ...
      h +=
        ...
        '<div style="font-family:Cinzel,serif;font-size:14px;letter-spacing:4px;color:#c1b085;text-align:center;margin-bottom:16px;">' +
        P[pi].n.toUpperCase() +
        " " +
        c +
        "/" +
      ...
      for (var ii = 0; ii < 6; ii++) {
        ...
        h +=
          '<div style="display:flex;align-items:center;gap:14px;padding:12px 0;border-bottom:1px solid rgba(193,176,133,0.08);">' +
          '<div style="width:24px;display:flex;justify-content:center;">' +
          icon +
          "</div>" +
          '<div style="font-family:Cinzel,serif;font-size:13px;letter-spacing:2px;color:' +
          (state === -1
            ? "#7A6842"
            : state === 1
            ? "#c1b085"
  ...
  function resultsHTML() {
    ...
    if (pts <= 10) {
      ...
      tier = "LEAN & READY";
      tierDesc =
        "Minimal digital and legal silos. A standard continuity plan would cover this.";
      tierRec = "Most people in this range start with The Vault.";
    } else if (pts <= 22) {
      desc = "Significant gaps remain";
      tier = "LEGACY AT RISK";
      tierDesc =
        "Some documentation exists, but access gaps and single points of failure remain.";
      tierRec = "Most people in this range benefit from The Archive.";
    } else if (pts <= 30) {
      desc = "Partially documented";
      tier = "CRITICAL COMPLEXITY";
      tierDesc =
        "High-value, multi-layered responsibilities. Risk of permanent asset loss without a clear system.";
      ...
      tierRec =
        "A focused review can confirm everything is current and accessible.";
    } else {
      desc = "Strongly organized";
      tier = "COMPREHENSIVE";
      tierDesc =
        "Thorough documentation across all pillars. Successor readiness is high.";
    ...
    for (var idx = 0; idx < 7; idx++) {
      ...
      brows +=
        '<div style="display:flex;align-items:center;justify-content:space-between;gap:18px;padding:16px 0;border-bottom:1px solid rgba(193,176,133,0.10);">' +
        '<div style="font-family:Cinzel,serif;font-size:13px;letter-spacing:3px;color:#9a8d7a;">' +
        P[idx].n.toUpperCase() +
        "</div>" +
        ...
        w +
        "%;background:" +
        (mxPillar ? "#c1b085" : "#7A6842") +
        ';"></div>' +
        "</div>" +
        '<div style="font-family:Bodoni Moda,serif;font-size:15px;font-style:italic;color:#c1b085;min-width:32px;text-align:right;">' +
        c +
        "/" +
        act +
        "</div>" +
    ...
    return (
      ...
      '<span style="font-family:Cinzel,serif;font-size:78px;font-weight:700;color:#c1b085;">' +
      pct +
      "</span>" +
      '<span style="font-family:Bodoni Moda,serif;font-size:28px;font-style:italic;color:#c1b085;margin-left:6px;">%</span>' +
      "</div>" +
      '<div style="font-family:Bodoni Moda,serif;font-size:16px;font-style:italic;color:#cfc3b0;margin-top:12px;text-align:center;">' +
      desc +
      "</div>" +
      "</div>" +
      "</div>" +
      '<div style="text-align:center;margin-bottom:10px;font-family:Cinzel,serif;font-size:15px;letter-spacing:5px;color:#b9a57b;">' +
      tot +
      " OF " +
      mx +
      " APPLICABLE POINTS</div>" +
      '<div style="text-align:center;margin-bottom:10px;font-family:Cinzel,serif;font-size:28px;font-weight:700;letter  function prog(active){
