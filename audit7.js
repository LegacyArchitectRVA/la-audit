...
(function(){
  ...
  function selectedBtnStyle(){
    return {
      border:'#c1b085',
      color:'#c1b085',
      bg:'rgba(193,176,133,0.05)',
      shadow:'0 0 12px rgba(193,176,133,0.45),0 0 24px rgba(193,176,133,0.18)'
    };
  }

  function idleBtnStyle(){
    return {
      border:'#4a3d28',
      color:'#8a7240',
      bg:'transparent',
  ...
  function pillarHTML(pi){
    ...
    var gate='';
    if(isP5){
      var y=OB===true?selectedBtnStyle():idleBtnStyle();
      var n=OB===false?selectedBtnStyle():idleBtnStyle();
      ...
      gate='<div style="margin-top:36px;padding-top:32px;border-top:1px solid #2a2218;margin-bottom:52px;">'+
        ...
        '<div style="display:flex;gap:12px;">'+
          '<button id="by" onclick="__la.by()" style="font-family:Cinzel,serif;font-size:14px;font-weight:700;letter-spacing:3px;padding:13px 32px;border:1px solid '+y.border+';background:'+y.bg+';color:'+y.color+';cursor:pointer;border-radius:1px;box-shadow:'+y.shadow+';">YES</button>'+
          '<button id="bn" onclick="__la.bn()" style="font-family:Cinzel,serif;font-size:14px;font-weight:700;letter-spacing:3px;padding:13px 32px;border:1px solid '+n.border+';background:'+n.bg+';color:'+n.color+';cursor:pointer;border-radius:1px;box-shadow:'+n.shadow+';">NO</button>'+
        '</div>'+
  ...
  function resultsHTML(){
    ...
    if(pts<=10){
      ...
      tierRec='Most people in this range start with <strong>The Vault</strong>.';
    }
    else if(pts<=22){
      desc='Significant gaps remain';
      tier='LEGACY AT RISK';
      tierDesc='Some documentation exists, but access gaps and single points of failure remain.';
      tierRec='Most people in this range benefit from <strong>The Archive</strong>.';
    }
    else if(pts<=30){
      ...
      tierRec='Most people in this range need <strong>The Legacy</strong>.';
    }
    else if(pts<36){
      desc='Well organized';
    ...
    return '<div style="font-family:Cinzel,serif;font-size:13px;letter-spacing:5px;color:#b8984e;text-align:center;margin-bottom:14px;">AUDIT COMPLETE</div>'+
      ...
      '<div style="padding:36px 0;border-top:1px solid #2a2218;text-align:center;">'+
        ...
        '<div style="text-align:center;">'+
          ...
          '<a href="/#contact" style="font-family:Cinzel,serif;font-size:12px;font-weight:700;letter-spacing:3px;color:#100d0a;background:#c1b085;text-decoration:none;display:inline-block;padding:17px 44px;border-radius:1px;transition:background 0.2s;">SCHEDULE A CONVERSATION</a>'+
