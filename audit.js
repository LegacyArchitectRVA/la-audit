  ...
  function pillarHTML(pi) {
    ...
    var backBtn = pi === 1
      ? '<a href="#go1" style="font-family:Cinzel,serif;font-size:12px;font-weight:700;letter-spacing:3px;color:#6b5a38;text-decoration:none;text-transform:uppercase;">BACK</a>'
      : '<button onclick="__la.go('+(pi)+')" style="font-family:Cinzel,serif;font-size:12px;font-weight:700;letter-spacing:3px;color:#6b5a38;background:none;border:none;cursor:pointer;text-transform:uppercase;padding:0;">BACK</button>';
    return prog(pi)+
  ...
  function resultsHTML() {
    ...
    for (var idx=0;idx<7;idx++) {
      ...
      brows+='<div style="display:flex;align-items:center;gap:16px;padding:11px 0;border-bottom:1px solid #2a2218;"><div style="font-family:Cinzel,serif;font-size:10px;letter-spacing:1.5px;color:#8a7240;width:150px;flex-shrink:0;">'+P[idx].n.toUpperCase()+'</div><div style="flex:1;height:1px;background:#342a1c;position:relative;"><div class="lab" data-w="'+w+'" style="position:absolute;top:0;left:0;height:100%;width:0%;background:'+(mx?'#c1b085':'#8a7030')+';transition:width 1.2s cubic-bezier(0.4,0,0.2,1);"></div></div><div style="font-family:Bodoni Moda,serif;font-size:15px;font-style:italic;color:'+(mx?'#b8984e':'#8a7240')+';width:28px;text-align:right;flex-shrink:0;">'+c+'/6</div></div>';
    }
    return '<div style="font-family:Cinzel,serif;font-size:12px;letter-spacing:5px;color:#b8984e;text-align:center;margin-bottom:14px;">AUDIT COMPLETE</div>'+
