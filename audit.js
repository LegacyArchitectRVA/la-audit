  ...
  function resultsHTML() {
    ...
    return '<div style="font-family:Cinzel,serif;font-size:12px;letter-spacing:5px;color:#b8984e;text-align:center;margin-bottom:14px;">AUDIT COMPLETE</div>'+
      ...
      '<div style="padding:48px 0 0;border-top:1px solid #2a2218;text-align:center;"><div style="font-family:Bodoni Moda,serif;font-size:21px;font-style:italic;color:#b0a494;line-height:1.6;margin-bottom:10px;">Your Life Manual starts here.</div><div style="font-family:Cinzel,serif;font-size:10px;letter-spacing:3px;color:#6b5a38;margin-bottom:36px;">SCHEDULE A PRIVATE CONVERSATION -- NO OBLIGATION</div><a href="https://cal.com/legacyarchitectrva/private-conversation" target="_blank" style="font-family:Cinzel,serif;font-size:12px;font-weight:700;letter-spacing:3px;color:#100d0a;background:#c1b085;text-decoration:none;display:inline-block;padding:17px 44px;border-radius:1px;">SCHEDULE A CONVERSATION</a><div style="display:flex;justify-content:center;gap:32px;margin-top:28px;"><button onclick="__la.go(7)" style="font-family:Cinzel,serif;font-size:10px;font-weight:700;letter-spacing:3px;color:#6b5a38;background:none;border:none;cursor:pointer;text-transform:uppercase;padding:0;">BACK</button><div onclick="__la.rs()" style="font-family:Cinzel,serif;font-size:10px;letter-spacing:3px;color:#4a3d28;cursor:pointer;">START OVER</div></div></div>';
  }
